...
import advantage from "../assets/features-icons/advatage.png"
  ...
  return (
    <div className="flex flex-col md:flex-row items-center gap-8">
      <div className="md:w-1/2">
        ...
        <h1 className="text-3xl font-bold mb-2 tracking-tighter capitalize">
          Why choose uiFry?
        </h1>
        <div className="flex items-center space-x-2 mb-4">
          <BsBell className="w-8 h-8 rounded-full bg-red-500 p-2 text-white" />
          <h1 className="font-semibold ">Clever Notification</h1>
        </div>
